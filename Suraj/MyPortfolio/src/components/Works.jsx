  ...
  return (
    ...
    >
      <Tilt
        ...
        scale={1.05}
        transitionSpeed={450}
        className='glassmorphism-bg p-5 rounded-2xl sm:w-[360px] w-full'
      >
        <div className='relative w-full h-[230px]'>
          <img
            src={image}
            alt='project_image'
            className='w-full h-full object-cover rounded-2xl parallax-effect'
          />
        ...
        <div className='mt-5 text-center'>
          <h3 className='text-white font-bold text-[24px] animated-gradient-text'>{name}</h3>
